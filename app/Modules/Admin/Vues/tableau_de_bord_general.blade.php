...
<div style="display:grid; grid-template-columns: repeat(3,1fr); gap:14px; margin-bottom:24px;">
    ...
    <div class="tdb-kpi {{ $margeBrutePeriode >= 0 ? 'tdb-kpi-green' : 'tdb-kpi-danger' }}">
        ...
        <div>
            ...
            {{-- Hors taxes des deux côtés : la TVA supportée à l'achat est
                 récupérable, elle n'est pas une charge. --}}
            <div class="tdb-kpi-sub">Taux : {{ $tauxMargePeriode }}% · ventes HT − achats HT</div>
        </div>
    </div>
